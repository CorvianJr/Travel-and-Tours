                ...
                <div class="booking-container"> 
                    ...
                    <div class="col-md-4">
                                <div class="bg-secondary rounded h-100 p-4">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="email" class="form-control" id="passNo"  placeholder="">
                                    ...
                                    <div class="container-col">
                                        ...
                                        <div class="column">  
                                            <div class="form-floating mb-3">
                                                <input type="email" class="form-control" id="fName"  placeholder="">
                                        ...
                                        <div class="column"> 
                                            <div class="form-floating mb-3">
                                                <input type="email" class="form-control" id="lName"  placeholder="" value="Smith">
